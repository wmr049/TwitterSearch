...
import static br.com.casadocodigo.twittersearch.NotificationUtil.createNotification;
...
public class NotificacaoService extends Service {
    ...
    private class AutenticacaoTask extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                String json = HttpRequest.post("https://api.twitter.com/oauth2/token").authorization("Basic "+ gerarChave()).form(data).body();
        ...
        private String gerarChave() throws UnsupportedEncodingException{
            String key = "5hBB4LVHsd71Xidzvq6ZfjFYf";
            String secret = "cdfMW7kcnbWOklY0iYw1onDmmaZFn3iuqDXxAQKoHdUgwlDCov";
    ...
    private class NotificacaoTask implements Runnable {
        ...
        private void criarNotificacao(String usuario, String texto, int id) {
            ...
            notificationManager.notify(id, createNotification(context, pendingIntent, titulo, texto, icone));
